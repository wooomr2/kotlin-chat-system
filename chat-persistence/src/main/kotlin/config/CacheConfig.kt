...
class CacheConfig {
    ...
    fun cacheManager(connectionFactory: RedisConnectionFactory): CacheManager {
        ...
        return RedisCacheManager.builder(connectionFactory)
            ...
            .withCacheConfiguration("users", configuration.entryTtl(Duration.ofMinutes(60)))
            .withCacheConfiguration("chatRooms", configuration.entryTtl(Duration.ofMinutes(15)))
            .withCacheConfiguration("chatRoomMemebers", configuration.entryTtl(Duration.ofMinutes(10)))
